...
const MorphingTrigger = () => {
  return (
    <div className="text-gray-700 hover: active:bg-gray-700 active:text-violet-60 focus:border-violet-60 disabled:text-gray-700 bg-transparent disabled:bg-transparent rounded-rounded group relative p-[6px]">
